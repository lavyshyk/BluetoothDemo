package com.lavyshyk.app.bledemo.service
...
import com.lavyshyk.app.bledemo.ui.log
import com.lavyshyk.app.bledemo.ui.toConnectionStateString
...
class GATTServerService : Service() {
    ...
    object SampleAdvertiseCallback : AdvertiseCallback() {
        override fun onStartSuccess(settingsInEffect: AdvertiseSettings?) {
            settingsInEffect.toString().log("settings effect from advertising callback")
            serverLogsState.value += "\nStarted advertising\n"
        }
